...
\section{Exploratory Analysis}
    ...
    % 1D PCA for stages and morphology
        ...
        Interestingly, PCA did not capture any noticeable differences even between distant stages (i.e. stage 1 and stage 4), where the differences in expression should be substantial and therefore reflected in the PCA results. This is also the case for two main distinct morphologies - Lobular and Ductal carcinomas, which overlap greatly in the plots.
           ...
           %\includegraphics[width=0.41\linewidth]{1dpcamorph2.png}
            ...
            \includegraphics[width=0.51\linewidth]{pcamorph_circle.pdf}\hfill
            \includegraphics[width=0.44\linewidth]{1dpcamorph.pdf}
            \hspace*{\fill}
    ...
    % barsplots for stages and morphology 
        ...
        \includegraphics[width=0.46\linewidth]{bar_morph4.pdf}\hfill
        \includegraphics[width=0.46\linewidth]{bar_stages4.pdf}
